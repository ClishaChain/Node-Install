...
echo "Starting ClishaChain Bootnode+Validator (Conservative Upgrade)..."
echo "
	[Unit]
	Description=Clisha Bootnode+Validator Service
	...
	SyslogIdentifier=clisha-bootnode-validator
	
	[Install]
	WantedBy=multi-user.target
" | sudo tee clisha.service
